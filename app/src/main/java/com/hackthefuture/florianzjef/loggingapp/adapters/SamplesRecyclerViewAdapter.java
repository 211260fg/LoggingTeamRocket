...
public class SamplesRecyclerViewAdapter extends RecyclerView.Adapter<SamplesRecyclerViewAdapter.SampleViewHolder>{

    private List<Sample> samples;
    private LogInteractionListener listener;

    public SamplesRecyclerViewAdapter(List<Sample> samples, LogInteractionListener listener) {
